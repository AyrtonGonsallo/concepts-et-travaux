...
export const environment = {
    production: false,
    apiUrl: 'http://localhost:3001', // URL de l'API locale
    ...
    assetsUrl:'http://localhost:4200/admin/assets/',
    //assetsUrl:'https://dev.homeren.fr/admin/assets/',
    //assetsUrl:'https://homeren.fr/admin/assets/',
