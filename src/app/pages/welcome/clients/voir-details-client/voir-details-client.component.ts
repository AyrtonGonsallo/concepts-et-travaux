...
@Component({
  selector: 'app-voir-details-client',
  templateUrl: './voir-details-client.component.html',
  styleUrl: './voir-details-client.component.css'
})
export class VoirDetailsClientComponent {
