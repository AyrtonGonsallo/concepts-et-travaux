...
@Component({
  selector: 'app-pose-equipements-cuisine-liste',
  templateUrl: './pose-equipements-cuisine-liste.component.html',
  styleUrl: './pose-equipements-cuisine-liste.component.css'
})
export class PoseEquipementsCuisineListeComponent {
size: NzButtonSize = 'large';
  ...
  loadDevisTaches(): void {
    this.devis_pieceService.get_devis_taches_by_travail(2)
