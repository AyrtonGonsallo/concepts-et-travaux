...
@Component({
  selector: 'app-renovation-electrique-complete-liste',
  templateUrl: './renovation-electrique-complete-liste.component.html',
  styleUrl: './renovation-electrique-complete-liste.component.css'
})
export class RenovationElectriqueCompleteListeComponent {
size: NzButtonSize = 'large';
  ...
  loadDevisTaches(): void {
    this.devis_pieceService.get_devis_taches_by_travail(15)
