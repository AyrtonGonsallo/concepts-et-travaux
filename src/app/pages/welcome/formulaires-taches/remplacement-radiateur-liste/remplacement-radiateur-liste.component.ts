...
@Component({
  selector: 'app-remplacement-radiateur-liste',
  templateUrl: './remplacement-radiateur-liste.component.html',
  styleUrl: './remplacement-radiateur-liste.component.css'
})
export class RemplacementRadiateurListeComponent {
size: NzButtonSize = 'large';
  ...
  loadDevisTaches(): void {
    this.devis_pieceService.get_devis_taches_by_travail(12)
