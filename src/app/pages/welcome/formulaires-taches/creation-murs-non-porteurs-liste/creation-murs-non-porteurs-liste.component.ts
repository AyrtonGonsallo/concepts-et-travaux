...
@Component({
  selector: 'app-creation-murs-non-porteurs-liste',
  templateUrl: './creation-murs-non-porteurs-liste.component.html',
  styleUrl: './creation-murs-non-porteurs-liste.component.css'
})
export class CreationMursNonPorteursListeComponent {
size: NzButtonSize = 'large';
  ...
  loadDevisTaches(): void {
    this.devis_pieceService.get_devis_taches_by_travail(4)
